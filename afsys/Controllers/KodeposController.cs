...
namespace afsys.Controllers
{
    ...
    public class KodeposController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                Utils.WriteLog("Error Message : \r\n" + ex.Message, "Itemcaf17Controller", "Index");
            }
        ...
        public ActionResult PopUpForm(String id)
        {
            ...
            try
            {
                ...
                ViewBag.lisKabupaten = Kabupaten.getObjectOptions(oCon, "0", "html", "");
                ...
                if (!String.IsNullOrEmpty(id))
                {
                    ...
                    if (oKodepos != null)
                    {
                        ...
                        ViewBag.lisKabupaten = Kabupaten.getObjectOptions(oCon, oKodepos.PROPINSI, "html", oKodepos.KABUPATEN);
            ...
            {
                Utils.WriteLog("Error Message : \r\n" + ex.Message, "Itemcaf17Controller", "PopUpForm");
            }
        ...
        public ActionResult Read(FormCollection collection)
        {
            ...
            {
                Utils.WriteLog("Error Message : \r\n" + ex.Message, "Itemcaf17Controller", "Read");
            }
